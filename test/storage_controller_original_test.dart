...
import 'package:logbook_app_089/storage_controller_original.dart';

/// ═══════════════════════════════════════════════════════════════════════════
/// TEST TERHADAP KODE ORIGINAL (SEBELUM PERBAIKAN)
/// File yang diuji: lib/storage_controller_original.dart
/// Tujuan: Menemukan bug pada source code original
/// ═══════════════════════════════════════════════════════════════════════════
void main() {
  group('StorageControllerOriginal - SharedPreferences', () {
    // ─────────────────────────────────────────────────────────────────────
    ...
    test('TC01 - saveToLocal lalu loadFromLocal harus mengembalikan nilai yang sama',
      ...
      final controller = StorageControllerOriginal();
      const key = 'score';
      const value = 10;
